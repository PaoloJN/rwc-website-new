        ...
        <div className="flex flex-col md:flex-row mt-[8rem] mb-[8rem]">
            ...
            <div className="flex flex-col md:w-[700px] gap-6 2xl:p-8 md:p-[200px_80px] pr-0 self-stretch text-center lg:flex-col 2xl:self-start 2xl:text-left mx-auto 2xl:mx-0">
                ...
                <div className="flex flex-col lg:flex-row gap-9">
                    <p className="text-lg">
                        At RWC, we foster a collaborative environment where students can explore
                        coding, share ideas, and work on projects that spark creativity and
                        innovation. Whether you&apos;re just starting out or looking to enhance your
                        skills, our community is here to support your journey in technology.
                    </p>
                    <p className="text-lg">
                        We recognize that our success is deeply intertwined with the growth and
                        accomplishments of our members. That’s why we prioritize learning,
                        collaboration, and inclusivity in all our activities. Together, we build
                        skills, embrace challenges, and create opportunities that prepare us for a
