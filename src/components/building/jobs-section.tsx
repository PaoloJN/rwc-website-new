            ...
            <div className="flex flex-col gap-9">
                <div className="flex flex-col items-start">
                    ...
                    <p className="text-[var(--Gray-25,#FCFCFD)] font-['Sansation'] text-[19px] font-normal leading-[36px] tracking-[0.048px] capitalize text-center mt-4 lg:text-left">
                        &quot;Join us now, as we empower students to unleash their potential, drive
                        innovation, and lead the way in shaping the future of technology. Together,
                        we build skills, foster creativity, and inspire leadership that transforms
                        ideas into reality.&quot;
                    </p>
                </div>
