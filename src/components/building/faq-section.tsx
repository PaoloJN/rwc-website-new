        ...
        <div className="max-w-6xl mx-auto space-y-12 pb-[100px] ">
            ...
            <div className="text-center space-y-8">
                ...
                <p className="text-lg text-gray-400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis enim sapien.
                    Pellentesque lacinia laoreet magna, non pretium vel.
                </p>
            </div>
            ...
            <div className="space-y-4">
                {faqs.map((faq, index) => (
                    <div
                        key={index}
                        className={`border ${
                            openIndices.includes(index) ? "border-purple-500" : "border-gray-600"
                        }  overflow-hidden`}
                    >
                        <div
